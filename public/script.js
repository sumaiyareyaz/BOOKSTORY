document.addEventListener('DOMContentLoaded', () => {
    ...
    const discoverBtn = document.querySelector('.menu-item:nth-child(1)');
    const categoryBtn = document.querySelector('.menu-item:nth-child(2)');
    ...
    function openModal(id){
        ...
        modalAuthor.innerText = 'by ' + b.author;
